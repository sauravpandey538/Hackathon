...
exports.up = async function (knex) {
  ...
  await knex("modules").insert([
    ...
    { name: "Introduction to Computing", faculty: "BCS", semester: "1" },
    { name: "Discrete Mathematics", faculty: "BCS", semester: "1" },
    { name: "Fundamentals of Programming", faculty: "BCS", semester: "1" },
    { name: "Communication Skills", faculty: "BCS", semester: "1" },
    { name: "Data Structures", faculty: "BCS", semester: "2" },
    {
      name: "Digital Logic & Computer Organization",
      faculty: "BCS",
      semester: "2",
    },
    { name: "Object-Oriented Programming", faculty: "BCS", semester: "2" },
    { name: "Probability & Statistics", faculty: "BCS", semester: "2" },
    { name: "Operating Systems", faculty: "BCS", semester: "3" },
    { name: "Database Management Systems", faculty: "BCS", semester: "3" },
    { name: "Software Engineering", faculty: "BCS", semester: "3" },
    { name: "Computer Networks", faculty: "BCS", semester: "3" },
    { name: "Web Development", faculty: "BCS", semester: "4" },
    { name: "Theory of Computation", faculty: "BCS", semester: "4" },
    { name: "Java Programming", faculty: "BCS", semester: "4" },
    { name: "Data Communication", faculty: "BCS", semester: "4" },
    { name: "Mobile Application Development", faculty: "BCS", semester: "5" },
    { name: "Cloud Computing", faculty: "BCS", semester: "5" },
    { name: "Data Analytics", faculty: "BCS", semester: "5" },
    { name: "Design & Analysis of Algorithms", faculty: "BCS", semester: "5" },
    { name: "Artificial Intelligence", faculty: "BCS", semester: "6" },
    { name: "Human-Computer Interaction", faculty: "BCS", semester: "6" },
    { name: "Information Security", faculty: "BCS", semester: "6" },
    { name: "Research Methodology", faculty: "BCS", semester: "6" },
    { name: "Machine Learning", faculty: "BCS", semester: "7" },
    { name: "Blockchain Technology", faculty: "BCS", semester: "7" },
    { name: "Advanced Web Technologies", faculty: "BCS", semester: "7" },
    { name: "Elective I", faculty: "BCS", semester: "7" },
    { name: "Capstone Project", faculty: "BCS", semester: "8" },
    { name: "Cyber Laws & Ethics", faculty: "BCS", semester: "8" },
    { name: "Big Data", faculty: "BCS", semester: "8" },
    { name: "Elective II", faculty: "BCS", semester: "8" },
